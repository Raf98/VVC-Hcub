...
set DESIGN  DST7_DCT8_16x16
set SYN_EFF medium
###set MAP_EFF medium
set MAP_EFF high
set DATE [clock format [clock seconds] -format "%b%d-%T"] 
set _OUTPUTS_PATH outputs_DST7_16x16#${DATE}
set _REPORTS_PATH reports_DST7_16x16#${DATE}
set _LOG_PATH logs_DST7_16x16#${DATE}
...
set_attribute hdl_search_path { ../DST7_DCT8_16x16 } /
...
read_hdl -vhdl {MCUHcub_DST7_DCT8_16x16.vhd DST7_DCT8_16x16.vhd}
...
shell irun -64 -v93 -top worklib.DST7_DCT8_16x16_TB ../DST7_DCT8_16x16/*.vhd ../testbenchs/DST7_16x16_TB.vhd -input ../testbenchs/DST7_16x16_vcd.tcl -access +rw > $_REPORTS_PATH/irun_DST7_16x16.log

puts "Reading .vcd file..."
#set_attribute find_takes_multiple_names  true
read_vcd -static -vcd_module DST7_DCT8_16x16 -module $DESIGN 16x16.vcd
...
write_saif  -computed $DESIGN > $_REPORTS_PATH/output_16x16.saif 
