...
set _OUTPUTS_PATH outputs_8x8#${DATE}
set _REPORTS_PATH reports_8x8#${DATE}
set _LOG_PATH logs_8x8#${DATE}
...
shell irun -64 -v93 -top worklib.DST7_DCT8_8x8_TB ../DST7_DCT8_8x8/*.vhd ../testbenchs/DST7_DCT8_8x8_TB.vhd -input ../testbenchs/8x8_vcd.tcl -access +rw  > $_REPORTS_PATH/irun_8x8.log
