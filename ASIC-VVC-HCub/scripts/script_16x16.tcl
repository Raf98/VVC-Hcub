...
set _OUTPUTS_PATH outputs_16x16#${DATE}
set _REPORTS_PATH reports_16x16#${DATE}
set _LOG_PATH logs_16x16#${DATE}
...
shell irun -64 -v93 -top worklib.DST7_DCT8_16x16_TB ../DST7_DCT8_16x16/*.vhd ../testbenchs/DST7_DCT8_16x16_TB.vhd -input ../testbenchs/16x16_vcd.tcl -access +rw  > $_REPORTS_PATH/irun_16x16.log
