...
set DESIGN  DST7_DCT8_8x8
set SYN_EFF medium
###set MAP_EFF medium
set MAP_EFF high
set DATE [clock format [clock seconds] -format "%b%d-%T"] 
set _OUTPUTS_PATH outputs_DCT8_8x8#${DATE}
set _REPORTS_PATH reports_DCT8_8x8#${DATE}
set _LOG_PATH logs_DCT8_8x8#${DATE}
...
set_attribute hdl_search_path { ../DST7_DCT8_8x8 } /
...
read_hdl -vhdl {MCUHcubparaDSTVII8x8.vhd DST7_DCT8_8x8.vhd}
...
shell irun -64 -v93 -top worklib.DST7_DCT8_8x8_TB ../DST7_DCT8_8x8/*.vhd ../testbenchs/DCT8_8x8_TB.vhd -input ../testbenchs/DCT8_8x8_vcd.tcl -access +rw  > $_REPORTS_PATH/irun_DCT8_8x8.log

puts "Reading .vcd file..."
#set_attribute find_takes_multiple_names  true
read_vcd -static -vcd_module DST7_DCT8_8x8 -module $DESIGN 8x8.vcd
...
write_saif  -computed $DESIGN > $_REPORTS_PATH/output_8x8.saif 
